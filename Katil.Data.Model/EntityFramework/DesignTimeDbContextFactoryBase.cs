...
namespace Katil.Data.Model.EntityFramework
{
    ...
    public class DbContextDesignTimeDbContextFactory
        : DesignTimeDbContextFactoryBase<KatilContext>
    {
        protected override KatilContext CreateNewInstance(
            DbContextOptions<KatilContext> options)
        {
            return new KatilContext(options, null);
        }
    }
}