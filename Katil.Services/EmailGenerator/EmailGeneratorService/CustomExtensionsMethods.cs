...
using Katil.Services.EmailGenerator.EmailGeneratorService.IntegrationEvents.EventHandling;
...
namespace Katil.Services.EmailGenerator.EmailGeneratorService
{
    public static class CustomExtensionsMethods
    {
        ...
        public static IServiceCollection AddCustomIntegrations(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddScoped<EmailGenerateIntegrationEventHandler, EmailGenerateIntegrationEventHandler>();
